...
async def saveScript(filename, id, proxy=''):
    ...
    <body>
        <div class="BODY"><div class="BACK"><a href="../index.html">返回索引页</a></div>
            ...
            <h4>音频下载地址：<a href="https://service-f6aayhze-1318894526.gz.apigw.tencentcs.com/release/wmyblog_podcast?filename={filename}.mp3&folder=Podcasts/wmyblog&type=exact">链接</a></h4>
...
def updateBlogData(nTask=20, proxy='',articleUpdate=True,gDriveUpdate=True,commentFullUpdate=False):
    ...
    id_list += ['162032391','108908773','171633910','164999328','131394982','108908755','108908678','131174635','125380740','108908753','108908771']
